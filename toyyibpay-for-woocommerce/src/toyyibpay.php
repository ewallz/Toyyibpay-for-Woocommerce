...
class toyyibpay extends WC_Payment_Gateway {
	function __construct() {
		...
		$this->icon = plugins_url('assets/tp.gif', __FILE__);
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'universal_channel'        => array(
				...
				'desc_tip' => __( 'Choose your preferred payment channel - FPX and/or credit card', 'toyyibPay' ),
				'type'    => 'select',
				'options' => array(
			        '0' => 'FPX Only',
	...
	public function process_payment( $order_id ) {
		...
		$post_args = array(
			...
			'channel'    => $this->universal_channel,
			'phone'    => $phone
		);
